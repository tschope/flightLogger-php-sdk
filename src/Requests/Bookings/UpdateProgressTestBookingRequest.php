...
class UpdateProgressTestBookingRequest extends GraphQLMutation
{
    protected string $id;
    ...
    {
        return <<<'GQL'
        mutation UpdateProgressTestBooking($id: Id!, $booking: ProgressTestBookingInput!) {
          updateProgressTestBooking(id: $id, booking: $booking) {
            id
            from
            to
          }
