...
class UpdateRentalBookingRequest extends GraphQLMutation
{
    protected string $id;
    ...
    {
        return <<<GQL
        mutation UpdateRentalBooking(\$id: Id!, \$booking: RentalBookingInput!) {
          updateRentalBooking(id: \$id, booking: \$booking) {
            id
            from
            to
          }
