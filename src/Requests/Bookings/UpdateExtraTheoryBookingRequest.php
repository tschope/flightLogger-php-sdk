...
class UpdateExtraTheoryBookingRequest extends GraphQLMutation
{
    protected string $id;
    ...
    {
        return <<<'GQL'
        mutation UpdateExtraTheoryBooking($id: Id!, $booking: ExtraTheoryBookingInput!) {
          updateExtraTheoryBooking(id: $id, booking: $booking) {
            id
            from
            to
          }
