...
class UpdateExamBookingRequest extends GraphQLMutation
{
    protected string $id;
    ...
    {
        return <<<'GQL'
        mutation UpdateExamBooking($id: Id!, $booking: ExamBookingInput!) {
          updateExamBooking(id: $id, booking: $booking) {
            id
            from
            to
          }
