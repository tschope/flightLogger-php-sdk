...
class UpdateSingleStudentBookingRequest extends GraphQLMutation
{
    protected string $id;
    ...
    {
        return <<<GQL
        mutation UpdateSingleStudentBooking(\$id: Id!, \$booking: SingleStudentBookingInput!) {
          updateSingleStudentBooking(id: \$id, booking: \$booking) {
            id
            from
            to
          }
