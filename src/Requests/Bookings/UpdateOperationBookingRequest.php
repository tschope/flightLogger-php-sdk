...
class UpdateOperationBookingRequest extends GraphQLMutation
{
    protected string $id;
    ...
    {
        return <<<'GQL'
        mutation UpdateOperationBooking($id: Id!, $booking: OperationBookingInput!) {
          updateOperationBooking(id: $id, booking: $booking) {
            id
            from
            to
          }
